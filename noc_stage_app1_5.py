...
def main(start_time):
    ...
    arch_traffic_file = "arch_Application_0" + app_name
    re_traffic_file = "reconfig_Application_0" + app_name
    architecture_file = "Heterogeneous_SoC_with_Ring_Topology"
    re_architecture_file = "reconfig_Application_0" + app_name + "_Heterogeneous_SoC_with_Ring_Topology"
