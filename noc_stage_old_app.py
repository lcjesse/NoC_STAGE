...
def make_traffic(traffic_file):
    with open(  traffic_file+".stp") as f:
        content = f.readlines()
...
def main(start_time):
    ...
    app_name = "fpppp"
    traffic_file = app_name + "_mesh_4x4"     ## here we assign traffic_file
    arch_traffic_file = "arch_" + app_name + "_mesh_4x4"
    re_traffic_file = "reconfig_" + app_name + "_mesh_4x4"
    architecture_file = "mesh_8nodes_16cores"
    re_architecture_file = "reconfig_" + app_name + "_mesh_8nodes_16cores"
